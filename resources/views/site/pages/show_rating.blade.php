...
<aside id="mainSidebar" class="bg-blue text-white vh-100 position-fixed sidebar-hidden"
 style="width: 280px; top: 0; left: 0; transition: transform 0.3s ease-in-out; z-index: 1000;">
    <div class="sidebar p-3">
        <!-- Logo -->
        <a href="{{$doctor->image}}" class="d-flex align-items-center text-white text-decoration-none mb-4">
            ...
            <ul class="nav flex-column gap-2">
                <li class="nav-item">
                    <a href="{{route('doctor.edit',$doctor->id)}}" class="nav-link text-white d-flex align-items-center">
                        <i class="fas fa-home me-2"></i> Edit My Data
                    </a>
                </li>
                <li class="nav-item">
...
<div class="container">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="fw-bold my-4 h4">
                <ol class="breadcrumb justify-content-center">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">My Rating</li>
                </ol>
            </nav>
            ...
            @foreach($ratings as $rating)
                <div class="mb-3 border-bottom pb-2">
                    ...
                    <br>
                    <form action="{{route('rate.destroy',$rating->id)}}" method="POST">
                        @csrf
                        @method('DELETE')
